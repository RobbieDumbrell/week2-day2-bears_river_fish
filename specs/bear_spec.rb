...
class TestBear < MiniTest::Test
  ...
  # set up a new instance of Bear each time.
  def setup
    @barry_the_bear = Bear.new("Barry", "Grizzly")
  ...
  def test_bear_takes_fish_from_river
    @barry_the_bear.take_fish("Fred")
    @amazon.remove_fish("Fred")
    assert_equal(["Fred"], @barry_the_bear.stomach)
  ...
  def test_bear_can_roar
    roar_noise = @barry_the_bear.roar
  ...
  def test_bear_food_count
    @barry_the_bear.take_fish("Fred")
    @amazon.remove_fish("Fred")
    amount_fish_in_stomach = @barry_the_bear.food_count
